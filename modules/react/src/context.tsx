/**
 * ChromiumView React Context
 *
 * Provides React context for accessing the ChromiumView API
...
/**
 * React context for ChromiumView
 */
...
export function ChromiumViewProvider({
  ...
  onReady,
  onError,
}: ChromiumViewProviderProps): React.ReactElement {
...
export function useChromiumViewAvailable(): boolean {
  ...
  useEffect(() => {
    setIsAvailable(isChromiumViewAvailable());
  }, []);

  return isAvailable;
}

export { ChromiumViewContext };
