All content in this repository is dual-licensed:

["No-Resale Software License v1.0"](./LICENSE.nrsl)
...
You may make modifications and [sell your game/application](#can-i-sell-a-gameapp-that-uses-this-software) that uses the modifications as that falls under _not_ "a product or service whose primary value is access to or use of the Software itself".

If you plan to sell _just_ the modified/forked software, you will need to use the [AGPLv3](./LICENSE.agpl) license for that, which has more conditions.
